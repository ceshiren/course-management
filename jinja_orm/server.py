...
def get_student():
    from course_model import StudentModel

    students = StudentModel.query.all()
    student_data = [{"stu_id": student.id,
                     "stu_name": student.name,
                     "selected_courses": "、".join([course.name for course in student.course_objs])

                     }
                    for student in students ]

    # return render_template("student.html")
    return render_template("student_new.html", stu_data=student_data)
